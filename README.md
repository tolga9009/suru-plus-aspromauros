...
These aspromautic or monochromatic icons are based on [Suru++ 30 Dark](https;//github.com/suru-plus/suru-plus-dark) icons of sizes 16, 24 and 32. It is flat, minimalist and designed for full dark environments. 

The word "Asprómauros" comes from the modern Greek word *ασπρόμαυρος*, which means *black and white*.

Observe that Suru++ Asprómauros also supports gradient colours, and is compatible with Oomox and with [Suru++ Colourise](https://github.com/suru-plus/suru-plus-colourise).
...
```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-aspromauros/master/install.sh | sh
```

#### HOME directory for GTK

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-aspromauros/master/install.sh | env DESTDIR="$HOME/.icons" sh
```

#### HOME directory for KDE

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-aspromauros/master/install.sh | env DESTDIR="$HOME/.local/share/icons" sh
```

#### \*BSD systems

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-aspromauros/master/install.sh | env DESTDIR="/usr/local/share/icons" sh
```
...
Please visit the [Design Guidelines](https://suru-plus.github.io/suru-plus-site).
...
* GPL3 © 2018-2019 Suru++ 30 by Suru++ Project.
