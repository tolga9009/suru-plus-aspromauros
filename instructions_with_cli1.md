...
svn export https://github.com/suru-plus/suru-plus-aspromauros/trunk/ ~/.icons/Suru++\ Asprómauros
# To update the next latest changes and to overwrite
svn export --force https://github.com/suru-plus/suru-plus-aspromauros/trunk/ ~/.icons/Suru++\ Asprómauros
```